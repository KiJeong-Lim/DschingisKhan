...
Module MyBinaryTrees.
  ...
  Global Notation " '[#'  lchild ']++<' key '>++[' rchild  '#]' " := (@BTnode _ lchild key rchild) (lchild at level 60, rchild at level 60, at level 60, no associativity) : my_data_structrue_scope.
