...
Module BasicCpoTheory.
  ...
  Proof. (* Thanks to Junyoung Jang *)
    ...
    - intros X X_nonempty X_isDirected sup_X sup_X_isSupremumOf_X sup_X_in_U_x. unnw.
      ...
      eapply ExclusiveMiddle.NNPP. intros H_false.
      contradiction JunyoungJang'sAdvice. intros y y_in_X.
      eapply ExclusiveMiddle.NNPP. intros y_in_U_x.
  ...
  Proof.
    ...
    assert (preimage_f_U_f_x2_isOpen : isOpen (preimage f (U (f x2)))) by now eapply f_isContinuousMap, U_x_isOpen.
